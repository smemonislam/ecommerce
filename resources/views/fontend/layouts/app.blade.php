                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col d-flex flex-row">
                                ...
                                <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{asset('fontend')}}/images/mail.png" alt=""></div><a href="https://colorlib.com/cdn-cgi/l/email-protection#234542505750424f465063444e424a4f0d404c4e"><span class="__cf_email__" data-cfemail="34525547404755585147745359555d581a575b59">[email&#160;protected]</span></a></div>
                                <div class="top_bar_content ml-auto">
                                    ...
                                    <div class="top_bar_user">
                                        @if (Route::has('login'))                                        
                                            ...
                                            <ul class="standard_dropdown top_bar_dropdown">
                                                <li>
                                                    <a href="javascript:voie(0)">{{ Auth::user()->name }}<i class="fas fa-chevron-down"></i></a>
                                            ...
                                            @else
                                            <div class="user_icon"><img src="{{asset('fontend')}}/images/user.svg" alt=""></div>
        ...
        <script>
            ...
            $( document ).ready(function() {
                ...
                function loadWishlist(){
                    $.ajax({
                        url: "{{ route('product.wishlist.count') }}",
                        method: 'GET',
                ...
                $('body').on('click', '.addWishlist', function(e){
                    ...
                    $.ajax({
                        url: "{{ route('product.wishlist.store', '') }}" + '/' + product_id,
                        method: 'POST',
                        data: {
